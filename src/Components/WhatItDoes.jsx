        ...
        <div className="whatitdoes-image">
            ...
            <div className="whatitdoesimg">
                ...
                <div className="what-text">
                    ...
                    <p style={{ fontFamily: "SFProDisplayRegular" }}>Just add your credit or debit card to the Wallet app on your iPhone and you’re ready to go.</p>
            ...
            <div className="whatitdoesimg">
                ...
                <div className="what-text">
                    ...
                    <p style={{ fontFamily: "SFProDisplayRegular" }}>No complicated processes to complete. No hassles.</p>
                </div>
            </div>
            ...
            <div className="whatitdoesimg">
                ...
                <div className="what-text">
                    ...
                    <p style={{ fontFamily: "SFProDisplayRegular" }}>Use Apple Cash with Apple Pay. Apple Cash is a digital card that lives in Wallet - it stores the cash you receive or want to send. </p>
